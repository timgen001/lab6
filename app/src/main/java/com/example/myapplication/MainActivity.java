...
public class MainActivity extends AppCompatActivity {
    ...
    public class MyAdapter extends BaseAdapter{
        ...
        @Override
        public View getView(int positoin, View convertView, ViewGroup parnet){
            convertView = getLayoutInflater().inflate(view,parnet,false);
            TextView name = convertView.findViewById(R.id.name);
            name.setText(data[positoin].name);
            ImageView imageView = convertView.findViewById(R.id.imageView);
            imageView.setImageResource(data[positoin].photo);
            return convertView;
        }
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String[] transNameArray = new String[]{"腳踏車","自行車","汽車","巴士"};
        int[] transPhotoIdArray = new int[]{R.drawable.trans1,R.drawable.trans2,R.drawable.trans3,
        R.drawable.trans4};
        ...
        String[] cubeeNameArray = new String[]{"哭哭","發抖","再見","生氣","昏倒","竊笑","很棒",
                "你好","驚嚇","大笑"};
